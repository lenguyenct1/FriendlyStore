            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/inventory-management')}}">Quản lý hàng tồn</a></li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/statistical-number-of-product')}}">Số lượng sản phẩm đã bán</a></li>
                        <li><a href="{{URL::to('/revenue-statistics')}}">Thống kê doanh thu trong tuần</a></li>
                        <li><a href="{{URL::to('/revenue-statistics-months')}}">Thống kê doanh thu trong tháng</a></li>
                         <li><a href="{{URL::to('/revenue-statistics-5-years')}}">Thống kê doanh thu trong 5 năm</a></li>
                 ...
                 <li class="sub-menu">
                   ...
                   <li class="sub-menu">
                    ...
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Quản lý xuất xứ</span>
                    </a>
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-origin')}}">Thêm xuất xứ</a></li>
                        <li><a href="{{URL::to('/all-origin')}}">Liệt kê xuất xứ</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-news')}}">Liệt kê tin tức</a></li>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>Hệ thống quản lý bán hàng Friendly-Store</p>
			</div>
		  </div>
  <!-- / footer -->
</section>
